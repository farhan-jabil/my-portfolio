...
export default function Contact() {
  return (
    <>
      ...
      <section id="contact" className="container py-12 md:py-24 lg:py-28 text-white text-center">
        <div className="mx-auto px-4">
          ...
          <div className="space-y-2 mt-6 md:mt-9 md:flex md:flex-col md:items-center">
            ...
            <div className="flex pt-3 justify-center items-center space-x-6">
              <a href="https://facebook.com/farhan.jabill" target="_blank">
                <i className="fa-brands fa-facebook text-2xl md:text-3xl"></i>
              </a>
              <a href="https://instagram.com/farhan_jabil" target="_blank">
                <i className="fa-brands fa-instagram text-2xl md:text-3xl"></i>
              </a>
              <a href="https://github.com/farhan-jabil" target="_blank">
                <i className="fa-brands fa-github text-2xl md:text-3xl"></i>
              </a>
              <a href="https://www.linkedin.com/in/farhan-hasan-751066162" target="_blank">
